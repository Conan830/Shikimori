...
PHOTO = "https://telegra.ph/file/8f2641bc79d9b28a275e2.jpg"

@register(pattern=("/alive"))
async def awake(event):
  text2 = f"**Heyaa.. Weeb! [{event.sender.first_name}](tg://user?id={event.sender.id}), I'M Shanks.** \n\n"
  ...
  BUTTON = [[Button.url("ᴜᴘᴅᴀᴛᴇs", "https://t.me/shanks_UPDATES"), Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/AstorSupport")]]
